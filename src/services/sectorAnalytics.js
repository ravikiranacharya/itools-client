export function fetchAllSectors() {
  return [
    { sectorId: 1, sectorName: "Automobiles" },
    { sectorId: 2, sectorName: "Building Mat." },
    { sectorId: 3, sectorName: "Cash & Others" },
    { sectorId: 4, sectorName: "Chem & Fertilizers" },
    { sectorId: 5, sectorName: "Chemicals & Fertilizers" },
    { sectorId: 6, sectorName: "Consumer Discretionary" },
    { sectorId: 7, sectorName: "Consumer Durables" },
    { sectorId: 8, sectorName: "Consumer Prod." },
    { sectorId: 9, sectorName: "Consumer Products" },
    { sectorId: 10, sectorName: "Consumer Serv." },
    { sectorId: 11, sectorName: "Consumer Services" },
    { sectorId: 12, sectorName: "Consumer Staples" },
    { sectorId: 13, sectorName: "Financials" },
    { sectorId: 14, sectorName: "Healthcare" },
    { sectorId: 15, sectorName: "Inds / Engg." },
    { sectorId: 16, sectorName: "Industrials" },
    { sectorId: 17, sectorName: "Industrials / Engineering" },
    { sectorId: 18, sectorName: "Infra & Cons." },
    { sectorId: 19, sectorName: "IT" },
    { sectorId: 20, sectorName: "Media & Ent" },
    { sectorId: 21, sectorName: "Metals & Mining" },
    { sectorId: 22, sectorName: "Misc" },
    { sectorId: 23, sectorName: "Oil & Gas" },
    { sectorId: 24, sectorName: "Power Utilities" },
    { sectorId: 25, sectorName: "Telecom" },
    { sectorId: 26, sectorName: "Unknown" },
    { sectorId: 27, sectorName: "Unknown/Misc" }
  ];
}

export function fetchSectorOverview(sectorId) {
  return {
    sectorDetails: {
      sectorId: 1,
    ...
    sectorData: {
      ...
      topInvestor: {
        id: "",
        name: "HDFC Mid-Cap Opp - G",
        investedAmount: 2416,
        denomination: "(Cr.)"
      },
      maximumDependant: {
        id: "",
        name: "Reliance Cap Builder -IV-B-G",
        weightage: 25.43
      }
    }
  };
...
export function fetchAMCWiseHoldings(sectorId) {
  const holdingsData = {
    AMCs: [
      {
        amcId: "1",
