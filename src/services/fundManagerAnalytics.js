export function fetchAllFundManagers() {
  return [
    { fundManagerId: 1, fundManagerName: "Ravi Kiran" },
    { fundManagerId: 2, fundManagerName: "Ravi Acharya" },
    { fundManagerId: 3, fundManagerName: "Ravi Mudumbai" }
  ];
}

export function fetchFundManagerOverview(fundManagerId) {
  return {
    fundManagerId: "1",
...
export function fetchSchemesManaged(fundManagerId) {
  return [
    {
      schemeId: "975",
...
export function fetchRiskReturnStatistics(fundManagerId) {
  return {
    schemes: [
      {
        schemeId: 861,
...
export function fetchPeerSchemePerformance(fundManagerId) {
  return {
    fundManagerId: 1,
...
export function fetchFundManagerPerformanceOverTime(fundManagerId) {
  return [
    { date: "31-Jul-2018", return: 4.18 },
    { date: "31-Dec-2018", return: 5.16 }
  ];
}
